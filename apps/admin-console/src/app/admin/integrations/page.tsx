    ...
    <div className="space-y-6 pb-16 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {(integrations || [
          {
            id: 'int_rzp_live',
            name: 'Razorpay PG Settlement Node',
            type: 'PAYMENT_GATEWAY',
            status: 'CONNECTED',
            environment: 'PRODUCTION',
            key_id: 'rzp_live_••••••••9102',
            webhook_url: 'https://api.razorcommerce.ai/v1/webhooks/razorpay',
            last_ping: '14s ago'
          },
          {
            id: 'int_sap_erp',
            name: 'SAP / Oracle General Ledger Sync',
            type: 'ERP_FINANCE',
            status: 'CONNECTED',
            environment: 'PRODUCTION',
            key_id: 'sap_oauth2_••••••••8819',
            webhook_url: 'https://erp-gateway.razorcommerce.ai/v1/ledger',
            last_ping: '1m ago'
          }
        ]).map((int) => (
          <div
