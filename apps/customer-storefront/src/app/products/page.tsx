            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-0.5">
                  All promotional products feature certified Razorpay merchant pricing, 18% GST invoice deduction, and AI AutoPay.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
            ...
            <button
              onClick={() => {
                ...
                setIsDealsOnly(next);
                if (next) {
                  router.replace('/products?deals=true');
                } else {
                  router.replace('/products');
                }
              }}
                    ...
                    <div className="flex items-center gap-1.5">
                      {isAutoPayEnabled ? (
                        <Button
                          ...
                          className="h-8 px-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-bold shadow-xs flex items-center gap-1.5 cursor-pointer"
                        >
