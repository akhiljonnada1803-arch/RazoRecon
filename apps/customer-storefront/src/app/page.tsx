        ...
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#072654] via-[#0A3875] to-[#0B72E7] text-white p-6 sm:p-10 shadow-xl border border-blue-900/30">
          ...
          <div className="max-w-3xl space-y-4 relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[11px] font-semibold text-blue-200">
              ...
              <span>CartMind AI Platform</span>
            </div>
            ...
            <p className="text-xs sm:text-sm md:text-base text-blue-100/90 leading-relaxed max-w-2xl font-normal">
              Discover products, compare options, explore reviews, calculate EMI, and buy with confidence using AI-powered shopping assistance.
            </p>
            ...
            <form onSubmit={handleSearchSubmit} className="pt-1 max-w-2xl">
              <div className="flex items-center rounded-2xl bg-white p-1 shadow-2xl border border-white/50 focus-within:ring-2 focus-within:ring-amber-300 transition-all">
                ...
                <input
                  ...
                  placeholder="Search products, POS terminals, soundboxes, or ask CartMind AI..."
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <Link href="/products?deals=true">
                <Button 
                  size="sm" 
                  variant="ghost" 
                  className="h-10 px-4 rounded-xl text-amber-300 hover:text-amber-200 hover:bg-white/10 font-bold text-xs gap-1.5"
                >
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
            <div className="space-y-3 max-w-xl">
              <Badge className="bg-blue-500/20 text-blue-200 border-blue-400/30 text-[11px] font-semibold px-3 py-1">
                CARTMIND AUTONOMOUS COPILOT
              </Badge>
              <h2 className="text-2xl sm:text-3xl font-black tracking-tight">
                CartMind AI Assistant
              </h2>
              <p className="text-xs sm:text-sm text-blue-100/80 leading-relaxed">
                Need help picking the best soundbox or POS machine for your store? Ask CartMind AI to compare specifications, calculate bulk GST discounts, and generate instant 1-click checkout bundles.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-3xl border border-white/15 max-w-md w-full space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-white">Ask CartMind AI</h4>
              ...
              <div className="p-3.5 bg-black/20 rounded-2xl border border-white/10 text-xs text-blue-100 leading-relaxed">
                "Hello! I am CartMind AI. I can match your store transaction volume with the most cost-efficient POS terminal, verify input tax credit, and create an instant checkout link."
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2 space-y-3">
              ...
              <p className="text-slate-500 max-w-sm leading-relaxed text-[11px]">
                Your AI Shopping Companion. Autonomous product discovery, real-time comparison, GST-inclusive transparent pricing, and instant multi-method checkout.
              </p>
